...
import { ZuiComponent, ZuiHorizontalAlignment } from './component'
...
export declare class ZTableColumn extends ZuiComponent {
  ...
  /** Whether column width can be resized. Works when border of `z-table` is `true` */
  resizable: boolean
  ...
  headerAlign: ZuiHorizontalAlignment
  ...
  /** multiple filter interview mode  */
  filterPlus: Boolean
