...
export declare class ZMessageBoxComponent extends Vue {
  title: string
  message: string
  type: MessageType
  iconClass: string
...
export interface ZMessageBoxOptions {
  ...
  callback?: (action: MessageBoxCloseAction, instance: ZMessageBoxComponent) => void

  /** Callback before MessageBox closes, and it will prevent MessageBox from closing */
  beforeClose?: (action: MessageBoxCloseAction, instance: ZMessageBoxComponent, done: (() => void)) => void
...
export interface ZMessageBoxShortcutMethod {
  (message: string, title: string, options?: ZMessageBoxOptions): Promise<MessageBoxData>
  (message: string, options?: ZMessageBoxOptions): Promise<MessageBoxData>
}

export interface ZMessageBox {
  /** Show a message box */
  (message: string, title?: string, type?: string): Promise<MessageBoxData>

  /** Show a message box */
  (options: ZMessageBoxOptions): Promise<MessageBoxData>
  ...
  setDefaults (defaults: ZMessageBoxOptions): void
